...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <!-- 'Boolean is have schedule Field' -->
    <div class="form-group row ">
        {!! Form::label('appointment', trans("lang.product_appointment"),['class' => 'col-3 control-label text-right']) !!}
        <div class="checkbox icheck">
            <label class="col-9 ml-2 form-check-inline">
                {!! Form::hidden('appointment', 0) !!}
                {!! Form::checkbox('appointment', 1, null) !!}
            </label>
        </div>
    </div>
...
{{--    @if($user->status =='waiting')--}}
    <div class="form-group row ">
        ...
        <div class="col-9">
            {!! Form::select('employees[] ', $employees, $employeesSelected, ['class' => 'select2 form-control' , 'multiple'=>'multiple']) !!}
            <div class="form-text text-muted">{{ trans("lang.market_employees_help") }}</div>
        </div>
    </div>
{{--    @endif--}}
